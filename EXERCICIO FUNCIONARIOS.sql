/*EXERCICIO FUNCIONARIOS (CURSO COMPLETO DE MYSQL - VERSÃO 3.0)
...
/* Contando número de dados para casos específicos (para determinar e otimizar as queries)
...
--desses dois setores.
select * from funcionarios
where (departamento = 'Lar' or departamento = 'Filmes') and
sexo = 'Feminino';
